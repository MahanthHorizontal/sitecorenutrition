  ...
  if (req.method === "GET") {
    ...
    try {
      ...
      const response = await fetch(
        "https://xmc-generalmill979f-xmcsbxc6f1-dev49a7.sitecorecloud.io/sitecore/api/graph/edge",
        {
          method: "POST",
          headers: {
  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      const apiRes = await fetch(
        "https://xmc-generalmill979f-xmcsbxc6f1-dev49a7.sitecorecloud.io/sitecore/api/authoring/graphql/v1",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
